...
$SITE_DOMAIN = "http://pili.erola.es"; /* your website domain name */
...
$TEMPLATEDIR = "http://pili.erola.es"; /* directory for template files; empty string if you don't have any templates */
